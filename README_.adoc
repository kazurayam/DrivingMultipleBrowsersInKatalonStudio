...
I made link:./Scripts/analysis/WebUI_openBrowser_twice/Script1640778957162.groovy[Test Cases/analysis/WebUI_openBrowser_twice] in Katalon Studio.

[source, groovy]
----
include::Scripts/analysis/WebUI_openBrowser_twice/Script1640778957162.groovy[]
----
