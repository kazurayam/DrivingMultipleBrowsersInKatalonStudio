...
https://flask.palletsprojects.com/en/2.0.x/tutorial/[Flask Tutorial]
...
This is the sample web app described in the document https://flask.palletsprojects.com/en/2.0.x/tutorial/["Flask Tutorial"]. It is _a basic blog application called Flaskr. Users will be able to register, log in, create posts, and edit or delete their own posts._ I just typed in the sample codes as published with very little modifications.
